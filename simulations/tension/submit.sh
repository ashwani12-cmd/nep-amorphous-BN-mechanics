...
# Run LAMMPS
time mpirun --mca btl ^openib -np $SLURM_NTASKS /home/IITB/multiscale-mechanics/ashwani12/software/builds/NEP_CPU/lammps-24Mar2022/src/lmp_mpi -in Tension.in > out.dat
